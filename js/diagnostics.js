  ...
  const checks = [
    {
      ...
      icon: '<i class="ph-bold ph-globe-hemisphere-west"></i>',
    ...
    },
    {
      ...
      icon: '<i class="ph-bold ph-lightning"></i>',
    ...
    },
    {
      ...
      icon: '<i class="ph-bold ph-broadcast"></i>',
    ...
    },
    {
      ...
      icon: '<i class="ph-bold ph-chart-bar"></i>',
      iconBg: 'rgba(115,138,255,0.12)',
    },
    {
      id: 'ipv6',
