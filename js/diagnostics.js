  ...
  const checks = [
    {
      ...
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round"><circle cx="128" cy="128" r="96"/><line x1="32" y1="128" x2="224" y2="128"/><path d="M128 32c-32 24-48 58-48 96s16 72 48 96"/><path d="M128 32c32 24 48 58 48 96s-16 72-48 96"/></svg>',
      iconBg: 'rgba(76,222,158,0.12)',
    },
    {
      id: 'dns',
      name: 'DNS Resolution',
      desc: 'Checking domain name resolution speed',
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round"><circle cx="112" cy="112" r="80"/><line x1="168" y1="168" x2="224" y2="224"/></svg>',
      iconBg: 'rgba(115,138,255,0.12)',
    },
    {
      id: 'latency',
      name: 'Latency Quality',
      desc: 'Measuring round-trip time to servers',
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round" stroke-linejoin="round"><polyline points="160,16 96,136 144,136 96,240"/></svg>',
      iconBg: 'rgba(253,214,99,0.12)',
    },
    {
      id: 'stability',
      name: 'Connection Stability',
      desc: 'Detecting packet loss and jitter',
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round"><circle cx="128" cy="144" r="14" fill="currentColor" stroke="none"/><path d="M90 108a54 54 0 0 1 76 0"/><path d="M58 76a96 96 0 0 1 140 0"/></svg>',
      iconBg: 'rgba(129,201,149,0.12)',
    },
    {
      id: 'bandwidth',
      name: 'Bandwidth Estimate',
      desc: 'Quick bandwidth check via Network API',
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round"><rect x="32" y="120" width="40" height="96" rx="4"/><rect x="108" y="72" width="40" height="144" rx="4"/><rect x="184" y="32" width="40" height="184" rx="4"/></svg>',
      iconBg: 'rgba(115,138,255,0.12)',
    },
    {
      id: 'ipv6',
      ...
      icon: '<svg width="18" height="18" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="18" stroke-linecap="round"><path d="M104 112a48 48 0 0 1 48 0l24-24a48 48 0 0 0-68-68L84 44a48 48 0 0 0 4 64"/><path d="M152 144a48 48 0 0 1-48 0l-24 24a48 48 0 0 0 68 68l24-24a48 48 0 0 0-4-64"/></svg>',
      iconBg: 'rgba(115,138,255,0.12)',
    },
  ];
